...
Person.insertMany([{
    name:"Fares Trojet",
    age:28,
    favoriteFoods:["FoodOne","FoodTwo","FoodThree"]
...
Person.create([
    {
        name:"Person X",
        age:40,
        favoriteFoods:["foodFour","foodFive"]
    },
    {
        name:"Person Y",
        age:50,
        favoriteFoods:["foodSix","foodSeven"]
    },
    {
        name:"Person Z",
        age:20,
        favoriteFoods:["foodEight","foodNine"]
    }
]).then(insertedElement => {console.log("The Inserted Elemenmt: ",insertedElement)});
...
Person.findOneAndUpdate({"name":"Fares Trojet"},{$set:{age:"20"}})
...
/* model.remove() */
Person.remove({name:"Fares Trojet"})
